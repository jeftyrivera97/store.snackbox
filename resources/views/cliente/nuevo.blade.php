        ...
        <div class="py-5 osahan-profile row">
            ...
            <div class="col-md-8 mb-3">
                <div class="rounded shadow-sm p-4" style="background: #000000">
                    <h5 class="mb-4 text-white text-center">¡Bienvenido {{$cliente->nombre}}! ¡Tu pedido ha sido procesado!</h5>
                    <form method="POST" action="{{ route('cliente-contraseña') }}">
                        @csrf
                    <div id="edit_profile">
                        <div>
                            <div class="alert alert-warning" role="alert">
                                Ya tienes acceso a tu cuenta. La proxima visita ingresa con tu correo electronico. Por favor cambia tu contraseña actual generada (123)! 
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="telefono" class="text-white" style="font-size: 14px;">Correo Electronico</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" readonly value="{{ Auth::user()->email }}">
                                <input type="text" hidden class="form-control" id="id" name="id" readonly value="{{ Auth::user()->id }}">
                            </div>

                            <div class="form-group row">
                                <label for="telefono" class="text-white" style="font-size: 14px;">Contraseña Actual (123)</label>
                                <input type="password" class="form-control" id="contraseña_actual" name="contraseña_actual" readonly value="123">
                            </div>
